...
export default function HomePage() {
  ...
  const loaderUser =async ()=>{
    ...
    // const result = await axios.get("http://fsapplicationcrud-production.up.railway.app/getUser")
    setUser(result.data);
  ...
  const deleteUser = async (id)=>{
    ...
    // await axios.delete(`http://fsapplicationcrud-production.up.railway.app/user/${id}`)
    loaderUser();
  }
